...
func newNodeTask(res *Restorer, parent *restoreTask, dir string, node *Node) *restoreTask {
	return &restoreTask{
		res:    res,
		parent: parent,
		class:  taskTypeNode,
...
func newDirTask(res *Restorer, parent *restoreTask, dir string, treeID ID) *restoreTask {
	return &restoreTask{
		res:    res,
		parent: parent,
		class:  taskTypeDir,
...
func (res *Restorer) addDirTask(parent *restoreTask, dir string, treeID ID) *restoreTask {
